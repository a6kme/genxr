...
if __name__ == "__main__":
    ...
    data_path = os.environ.get('DATA_PATH') or os.path.join(os.getcwd(), os.pardir, "data", "images", "images")
    #data_path = os.path.join(os.getcwd(), os.pardir, "data", "images")
    meta_path = os.path.join(os.environ.get('PROJECT_PATH'), 'meta') or os.path.join(os.getcwd(), os.pardir, "meta")
    ...
    dfs_holder, dfs_names = t.get_dataframes(
        meta_path, diseases="all", data=config["training"]["data_size"]
    )
